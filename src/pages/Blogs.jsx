...
import "../styles/blogsPage.css"; // ✅ nuevo CSS
...
export default function Blogs() {
  return (
    <main className="blogs-page-wrapper">
      <h1 className="blogs-page-title">📰 Noticias Importantes</h1>

      {/* Blog 1 */}
      <div className="blogs-card">
        <div className="blogs-info">
          <h2>¿Un pastel para una alcaldesa? El detrás de cámaras de una creación muy especial</h2>
          <p>
          ...
          <Link to="/blog1" className="blogs-btn">Ver más</Link>
        </div>
      ...
      <div className="blogs-card">
        <div className="blogs-info">
          ...
          <Link to="/blog2" className="blogs-btn">Ver más</Link>
        </div>
        <div className="blogs-img">
      ...
      <div className="blogs-card">
        <div className="blogs-info">
          ...
          <Link to="/blog3" className="blogs-btn">Ver más</Link>
        </div>
        <div className="blogs-img">
      ...
      <div className="blogs-card">
        <div className="blogs-info">
          ...
          <Link to="/blog4" className="blogs-btn">Ver más</Link>
        </div>
        <div className="blogs-img">
